...
class _SleepDetailScreenState extends State<SleepDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final totalMinutes = SampleData.sleepData
        .map((e) => e.duration.inMinutes)
        .reduce((a, b) => a + b);
    final avgMinutes = totalMinutes ~/ SampleData.sleepData.length;
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppTheme.sleepBackgroundColor,
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  height: 80,
                  decoration: BoxDecoration(
                    color: AppTheme.sleepAccentColor.withOpacity(0.2),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: const Icon(
                    Icons.hotel,
                    size: 40,
                    color: AppTheme.sleepAccentColor,
                  ),
                ),
              ],
            ),
            ...
            child: Padding(
              ...
              child: BarChart(
                BarChartData(
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          ...
                          if (index >= 0 && index < SampleData.sleepData.length) {
                            final date = SampleData.sleepData[index].date;
                            return Padding(
                  ...
                  barGroups: SampleData.sleepData.asMap().entries.map((entry) {
